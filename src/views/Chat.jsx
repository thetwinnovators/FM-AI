...
function Sidebar({ activeId, onNew }) {
  ...
  return (
    <aside
      ...
      style={{ background: 'linear-gradient(180deg, rgba(5, 7, 15, 0.35) 0%, rgba(5, 7, 15, 0.65) 100%)' }}
    >
      <div className="p-3">
    ...
    <div className="flex" style={{ height: 'calc(100vh - 100px)' }}>
      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(180deg, rgba(5, 7, 15, 0.35) 0%, rgba(5, 7, 15, 0.65) 100%)',
          }}
        >
